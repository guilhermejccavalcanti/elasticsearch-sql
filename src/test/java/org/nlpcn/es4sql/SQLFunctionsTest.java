...
public class SQLFunctionsTest {
    ...
    public void functionFieldAliasAndGroupByAlias() throws Exception {
        String query = "SELECT " + "floor(substring(address,0,3)*20) as key," + "sum(age) cvalue FROM " + TestsConstants.TEST_INDEX + "/account where address is not null " + "group by key order by cvalue desc limit 10  ";
    ...
    public void functionAlias() throws Exception {
        String query = "SELECT " + "substring(address,0,3) as key,address from " + TestsConstants.TEST_INDEX + "/account where address is not null " + "order by address desc limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
        List<String> content = csvResult.getLines();
        Assert.assertTrue(headers.contains("key"));
    ...
    public void normalFieldAlias() throws Exception {
        String query = "SELECT " + "address as key,age from " + TestsConstants.TEST_INDEX + "/account where address is not null " + "limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
        Assert.assertTrue(headers.contains("key"));
    }
    ...
    public void groupByFieldAlias() throws Exception {
        String query = "SELECT " + "age as key,sum(age) from " + TestsConstants.TEST_INDEX + "/account where address is not null " + " group by key limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
    ...
    public void concat_ws_field_and_string() throws Exception {
        String query = "SELECT " + " concat_ws(\'-\',age,\'-\'),address from " + TestsConstants.TEST_INDEX + "/account " + " limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
        List<String> contents = csvResult.getLines();
        String[] splits = contents.get(0).split(",");
    ...
    public void whereConditionLeftFunctionRightVariableEqualTest() throws Exception {
        String query = "SELECT " + " * from " + TestsConstants.TEST_INDEX + "/account " + " where split(address,\' \')[0]=\'806\' limit 1000  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> contents = csvResult.getLines();
    ...
    public void whereConditionLeftFunctionRightVariableGreatTest() throws Exception {
        String query = "SELECT " + " * from " + TestsConstants.TEST_INDEX + "/account " + " where floor(split(address,\' \')[0]+0) > 805 limit 1000  ";
        SearchDao searchDao = MainTestSuite.getSearchDao() != null ? MainTestSuite.getSearchDao() : getSearchDao();
        System.out.println(searchDao.explain(query).explain().explain());
        CSVResult csvResult = getCsvResult(false, query);
        List<String> contents = csvResult.getLines();
    ...
    public void whereConditionLeftFunctionRightPropertyGreatTest() throws Exception {
        String query = "SELECT " + " * from " + TestsConstants.TEST_INDEX + "/account " + " where floor(split(address,\' \')[0]+0) > b limit 1000  ";
    ...
    public void whereConditionLeftFunctionRightFunctionEqualTest() throws Exception {
        String query = "SELECT " + " * from " + TestsConstants.TEST_INDEX + "/account " + " where floor(split(address,\' \')[0]+0) = floor(split(address,\' \')[0]+0) limit 1000  ";
        Select select = parser.parseSelect((SQLQueryExpr) queryToExpr(query));
        Where where = select.getWhere();
        Assert.assertTrue((where.getWheres().size() == 1));
        Assert.assertTrue(((Condition) (where.getWheres().get(0))).getValue() instanceof ScriptFilter);
    ...
    public void whereConditionVariableRightVariableEqualTest() throws Exception {
        String query = "SELECT " + " * from " + TestsConstants.TEST_INDEX + "/account " + " where a = b limit 1000  ";
        SearchDao searchDao = MainTestSuite.getSearchDao() != null ? MainTestSuite.getSearchDao() : getSearchDao();
        System.out.println(searchDao.explain(query).explain().explain());
        Select select = parser.parseSelect((SQLQueryExpr) queryToExpr(query));
        Where where = select.getWhere();
    ...
    public void concat_ws_fields() throws Exception {
        String query = "SELECT " + " concat_ws(\'-\',age,address),address from " + TestsConstants.TEST_INDEX + "/account " + " limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
        List<String> contents = csvResult.getLines();
    ...
    public void split_field() throws Exception {
        String query = "SELECT " + " split(address,\' \')[0],age from " + TestsConstants.TEST_INDEX + "/account where address is not null " + " limit 10  ";
        CSVResult csvResult = getCsvResult(false, query);
        List<String> headers = csvResult.getHeaders();
        List<String> contents = csvResult.getLines();
        String[] splits = contents.get(0).split(",");
    ...
    private SearchDao getSearchDao() throws UnknownHostException {
        ...
        Client client = TransportClient.builder().addPlugin(DeleteByQueryPlugin.class).settings(settings).build().addTransportAddress(MainTestSuite.getTransportAddress());
